    ...
    <div class="min-h-screen bg-[#fafafa]">
      ...
      <footer class="px-6 md:px-12 py-8 border-t border-[#eee]">
        <div class="max-w-6xl mx-auto flex justify-center">
          <a href="https://github.com/mikepage/intl-tel-validate" target="_blank" rel="noopener noreferrer" class="text-[#999] hover:text-[#666] flex items-center gap-2 text-xs">
